...
#ifndef ___LINKED_LIST_TESTS_INCLUDED
#define ___LINKED_LIST_TESTS_INCLUDED

/* Implicitly tested methods:
   `iterator', `length' for linkedList_t and `hasNext', `next' for linkedListIterator_t. */

struct linkedListTestsStruct {
...
extern const struct linkedListTestsStruct linkedListTests;
