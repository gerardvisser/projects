...
# ifndef ___LOMBOK__BASE__DBG_ALLOC_INFO_INCLUDED
#  define ___LOMBOK__BASE__DBG_ALLOC_INFO_INCLUDED

class dbgAllocInfo_t {
private:
  long int allocCount;
  long int freeCount;
  long int allocated;
  long int allocatedMax;
  long int freed;

public:
  dbgAllocInfo_t (void);
  virtual ~dbgAllocInfo_t (void);
