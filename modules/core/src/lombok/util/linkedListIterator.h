...
#ifndef ___LOMBOK__UTIL__LINKED_LIST_ITERATOR_INCLUDED
#define ___LOMBOK__UTIL__LINKED_LIST_ITERATOR_INCLUDED

#include <lombok/util/linkedList.h>
#include "linkedListNode.h"

class linkedListIterator_t : public listIterator_t {
private:
  linkedList_t* const list;
  linkedListNode_t* _next;

public:
  linkedListIterator_t (linkedList_t* list);
  virtual ~linkedListIterator_t (void);
