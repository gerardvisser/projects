...
#ifndef ___LOMBOK__PARSING__TOKENISERS__JAVA_TOKENISER_INCLUDED
#define ___LOMBOK__PARSING__TOKENISERS__JAVA_TOKENISER_INCLUDED

#include <lombok/parsing/tokenisers/tokeniser.h>

namespace pars {

  class javaTokeniser_t : public tokeniser_t {
  public:
    javaTokeniser_t (void);

  protected:
    virtual token_t* createSecondaryToken (pushbackStream_t* stream, int cr);
